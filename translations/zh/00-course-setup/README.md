...
![分叉的代码库](../../../00-course-setup/images/forked-repo.png)
...
1. 在屏幕左侧的 **开发者设置** 中选择 `精细化令牌` 选项。
  ...
  ![开发者设置](../../../00-course-setup/images/profile_developer_settings.png)

   然后选择 `生成新令牌`。

  ![生成令牌](../../../00-course-setup/images/fga_new_token.png)
...
2. 输入一个描述性名称，反映令牌的用途，便于以后识别。
    ...
    ![令牌名称和到期日期](../../../00-course-setup/images/token-name-expiry-date.png)

3. 将令牌的作用域限制为此代码库的分叉。

    ![将作用域限制为分叉代码库](../../../00-course-setup/images/token_repository_limit.png)

4. 限制令牌的权限：在 **权限** 下，点击 **账户** 标签，然后点击 "+ 添加权限" 按钮。会出现一个下拉菜单。请搜索 **Models** 并勾选它。

    ![添加 Models 权限](../../../00-course-setup/images/add_models_permissions.png)

5. 在生成令牌之前，验证所需权限。![验证权限](../../../00-course-setup/images/verify_permissions.png)

6. 在生成令牌之前，请确保您已准备好将令牌存储在安全的地方，例如密码管理器，因为生成后将无法再次查看。![安全存储令牌](../../../00-course-setup/images/store_token_securely.png)
...
![GitHub Token 字段](../../../00-course-setup/images/github_token_field.png)
...
![项目连接字符串](../../../00-course-setup/images/project-endpoint.png)
